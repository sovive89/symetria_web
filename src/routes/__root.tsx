...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Symetra — Tecnologia para evolução estética" },
      {
        name: "description",
        content:
          "Plataforma que conecta profissionais e pacientes de estética com agenda, CRM, evolução visual e dados sob consentimento.",
      },
